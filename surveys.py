class Question:
    ...
    def __repr__(self):
        """A representation of the Question object"""
        cls = self.__class__.__name__
        return f"""{cls}(question={self.question}, choices={self.choices}, 
...
class Survey:
    ...
    def __repr__(self):
        """A representation of the Survey object"""
        cls = self.__class__.__name__
        return f"""{cls}(title={self.title},
         instruction={self.instructions}, questions={self.questions})"""
